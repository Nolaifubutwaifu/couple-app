...
async function signup() {
  var ageRow = document.getElementById("ageConfirmRow");
  var ageCheck = document.getElementById("ageConfirmCheck");

  if (ageRow.style.display === "none" || ageRow.style.display === "") {
  ...
  if (!ageCheck.checked) {
    setStatus(authMessage, "Please confirm you are 17 years or older.", "error");
    return;
  }
